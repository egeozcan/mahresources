...
func main() {
	...
	downloadCockpitLimit := flag.Int("download-cockpit-limit", parseIntEnv("DOWNLOAD_COCKPIT_LIMIT", 10), "Deprecated compatibility setting; the Job Center panel has its own recent-Job limit (env: DOWNLOAD_COCKPIT_LIMIT)")
