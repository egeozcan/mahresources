...
func main() {
	...
	downloadCockpitLimit := flag.Int("download-cockpit-limit", parseIntEnv("DOWNLOAD_COCKPIT_LIMIT", 10), "How many finished jobs the Jobs drawer shows; running, queued and failed jobs are always listed (env: DOWNLOAD_COCKPIT_LIMIT)")
