...
type NoteBlock struct {
	...
	NoteID    uint       `gorm:"index:idx_note_type_position,priority:1;index:idx_note_position,priority:1;not null" json:"noteId"`
	...
	Position  string     `gorm:"index:idx_note_type_position,priority:3;index:idx_note_position,priority:2;not null" json:"position"`
