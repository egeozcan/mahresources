 ...
 * and Bug 3: $ref/allOf recursion drops describedBy and isRequired.
 *
...
// ─── Bug 3: $ref/allOf recursion drops describedBy and isRequired ─────────

/**
 * Verify that _renderField forwards describedBy and isRequired through
 * $ref and allOf recursive calls by inspecting the source code.
 */
