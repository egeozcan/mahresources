...
>
    ...
    >
        ...
        <kbd class="hidden sm:inline px-1.5 py-0.5 text-xs bg-white rounded border border-stone-300 font-sans" aria-hidden="true">
            ...
            <div class="relative min-h-screen flex items-start justify-center pt-[12vh] px-4" @click="close()">
                ...
                >
                    ...
                    >
                        <template x-for="(result, index) in results" :key="result.type + '-' + result.id">
                            <li
                                ...
                                :class="selectedIndex === index ? 'bg-amber-50' : 'hover:bg-stone-50'"
                            >
                                <div class="flex items-center gap-3">
                                    <span
                                        class="flex-shrink-0 w-9 h-9 flex items-center justify-center rounded-lg text-lg"
                                        :class="selectedIndex === index ? 'bg-amber-100' : 'bg-stone-100'"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="font-medium text-stone-900 truncate"
                                        ...
                                        <p
                                            ...
                                            class="text-sm font-sans text-stone-600 truncate mt-0.5"
                                        ...
                                        >
                                            <template x-for="(value, key) in (result.extra || {})" :key="key">
                                                <span class="text-xs text-stone-600" x-text="value"></span>
                                            </template>
                                        </div>
                                    </div>

                                    <svg x-show="selectedIndex === index" class="w-4 h-4 text-amber-700 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                        ...
                        <p class="text-stone-500">No results found for "<span class="font-medium" x-text="query"></span>"</p>
                    ...
                    >
                        ...
                        <p class="text-stone-500">Start typing to search</p>
                        <p class="text-sm font-sans text-stone-600 mt-1">Search across all your resources, notes, groups, and more</p>
                    </div>

                    <div class="flex items-center justify-center gap-6 px-4 py-2.5 bg-stone-50/80 border-t border-stone-100 text-xs text-stone-600">
                        <span class="flex items-center gap-1.5">
                            <kbd class="px-1.5 py-0.5 bg-white rounded border border-stone-200 font-sans text-stone-500 shadow-sm">&uarr;</kbd>
                            <kbd class="px-1.5 py-0.5 bg-white rounded border border-stone-200 font-sans text-stone-500 shadow-sm">&darr;</kbd>
                            <span>navigate</span>
                        </span>
                        <span class="flex items-center gap-1.5">
                            <kbd class="px-1.5 py-0.5 bg-white rounded border border-stone-200 font-sans text-stone-500 shadow-sm">&crarr;</kbd>
                            <span>select</span>
                        </span>
                        <span class="flex items-center gap-1.5">
                            <kbd class="px-2 py-0.5 bg-white rounded border border-stone-200 font-sans text-stone-500 shadow-sm">esc</kbd>
                            <span>close</span>
                        </span>
                    </div>
                </div>
