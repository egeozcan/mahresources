<div class="bg-white shadow rounded-lg p-4">
    <div class="bg-gray-50 border border-gray-200 rounded p-3 mb-6 text-gray-600 text-sm flex items-center gap-2">
    ...
    <div class="grid grid-cols-2 gap-6">
        <div class="border rounded overflow-hidden text-center">
            ...
            <div class="p-4">
                ...
                {% else %}
                <div class="w-24 h-24 bg-gray-100 mx-auto mb-3 flex items-center justify-center rounded">
                    <span class="text-gray-500 text-xs">{{ comparison.Version1.ContentType }}</span>
                </div>
                {% endif %}
                <p class="text-sm text-gray-500 mb-3">{{ comparison.Version1.FileSize|humanReadableSize }}</p>
        ...
        <div class="border rounded overflow-hidden text-center">
            ...
            <div class="p-4">
                ...
                {% endif %}
                <p class="text-sm text-gray-500 mb-3">{{ comparison.Version2.FileSize|humanReadableSize }}</p>
