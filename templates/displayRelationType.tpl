...
{% include "/partials/description.tpl" with description=relationType.Description descriptionEditUrl="/v1/relation/editDescription" descriptionEditId=relationType.ID %}
