...
{% block body %}
    ...
    <section class="mb-6" aria-label="Resource metadata">
        ...
        <details class="mt-3">
            <summary class="cursor-pointer text-sm text-stone-500 hover:text-stone-700 select-none py-1">Technical Details</summary>
...
{% block sidebar %}
    ...
    {% if isImage %}
        ...
        <form action="/v1/resource/recalculateDimensions?redirect={{ url|urlencode }}" method="post">
            <input type="hidden" name="id" value="{{ resource.ID }}">
            <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium font-mono rounded-md text-white bg-amber-700 hover:bg-amber-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-600">Recalculate Dimensions</button>
        </form>
        ...
        <form action="/v1/resources/rotate" method="post">
            ...
            <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium font-mono rounded-md text-white bg-amber-700 hover:bg-amber-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-600">Rotate</button>
        </form>
    {% endif %}
