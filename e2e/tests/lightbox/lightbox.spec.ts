...
test.describe('Lightbox Functionality', () => {
  ...
  test('should open lightbox when clicking an image', async ({ page }) => {
    ...
    const lightboxImage = lightbox.locator('[data-lightbox-media] img');
...
test.describe('Lightbox SVG Support', () => {
  // BH-039 (fixed in c14): the BH-011 image ingestion guard now narrows to
  // image.ErrFormat vs real decode errors. SVG/ICO/AVIF/HEIC uploads succeed
  // with Width=0/Height=0; truncated PNGs still reject. The SVG lightbox
  // suite is unskipped here.
