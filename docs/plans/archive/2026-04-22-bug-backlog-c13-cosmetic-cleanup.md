...
**Top-level spec:** `docs/plans/archive/2026-04-22-bughunt-batch-c9-c18-design.md` — Cluster 13 section. c13 is small enough that a dedicated cluster spec would be redundant; the top-level spec section is sufficient.
...
Spec: `docs/plans/archive/2026-04-22-bughunt-batch-c9-c18-design.md` — Cluster 13 section.
Plan: `docs/plans/archive/2026-04-22-bug-backlog-c13-cosmetic-cleanup.md`.
