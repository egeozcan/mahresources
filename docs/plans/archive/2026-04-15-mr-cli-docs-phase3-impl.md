...
**Spec reference:** `docs/plans/archive/2026-04-15-mr-cli-docs-phase3-design.md` (parent: `docs/plans/archive/2026-04-14-mr-cli-docs-design.md`).
...
Expected: only the stray files mentioned in the session start (`test.db-shm`, `test.db-wal`, the old plan drafts under `docs/plans/archive/2026-04-12-*.md`, `docs/plans/archive/2026-04-14-import-guid-fixes-plan.md`). No modified tracked files.
