...
2. Write a per-cluster spec at `docs/plans/archive/YYYY-MM-DD-c{N}-{theme}-design.md` — copied from this plan's cluster entry, refined against current repo state.
