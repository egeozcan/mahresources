...
func TestJobCoreMigrationSeedsTheWriterEpoch(t *testing.T) {
	...
	for _, table := range []string{"jobs", "job_events", "job_event_sequences", "job_links", "job_outputs", models.JobReplayEnvelopeTable, "job_claims", "job_capacity_leases", models.JobWriterEpochTable} {
