...
| Command | Short | |
|---------|-------|--|
| `mr admin` | Show admin statistics (server health, data counts, expensive stats) | [Details](./admin.md) |
...
| `mr group export` | Export one or more groups (and their reachable entities) to a tar file | [Details](./group/export.md) |
