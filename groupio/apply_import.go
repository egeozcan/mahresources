	...
	for _, entry := range s.plan.Mappings.Categories {
		...
		if entry.HasPayload {
			if def := findCategoryDef(s.collector.categoryDefs, entry.SourceExportID); def != nil {
				...
				cat.CustomHeaderCSS = def.CustomHeaderCSS
				cat.CustomSidebar = def.CustomSidebar
				cat.CustomSidebarCSS = def.CustomSidebarCSS
				cat.CustomSummary = def.CustomSummary
				cat.CustomSummaryCSS = def.CustomSummaryCSS
				cat.CustomAvatar = def.CustomAvatar
				cat.CustomAvatarCSS = def.CustomAvatarCSS
				cat.CustomListHeader = def.CustomListHeader
				cat.CustomListHeaderCSS = def.CustomListHeaderCSS
				cat.CustomDetailFooter = def.CustomDetailFooter
				cat.CustomDetailFooterCSS = def.CustomDetailFooterCSS
				cat.CustomListFooter = def.CustomListFooter
				cat.CustomListFooterCSS = def.CustomListFooterCSS
				cat.CustomHoverCard = def.CustomHoverCard
				cat.CustomHoverCardCSS = def.CustomHoverCardCSS
	...
	for _, entry := range s.plan.Mappings.NoteTypes {
		...
		if entry.HasPayload {
			if def := findNoteTypeDef(s.collector.noteTypeDefs, entry.SourceExportID); def != nil {
				...
				nt.CustomHeaderCSS = def.CustomHeaderCSS
				nt.CustomSidebar = def.CustomSidebar
				nt.CustomSidebarCSS = def.CustomSidebarCSS
				nt.CustomSummary = def.CustomSummary
				nt.CustomSummaryCSS = def.CustomSummaryCSS
				nt.CustomAvatar = def.CustomAvatar
				nt.CustomAvatarCSS = def.CustomAvatarCSS
				nt.CustomListHeader = def.CustomListHeader
				nt.CustomListHeaderCSS = def.CustomListHeaderCSS
				nt.CustomDetailFooter = def.CustomDetailFooter
				nt.CustomDetailFooterCSS = def.CustomDetailFooterCSS
				nt.CustomListFooter = def.CustomListFooter
				nt.CustomListFooterCSS = def.CustomListFooterCSS
				nt.CustomHoverCard = def.CustomHoverCard
				nt.CustomHoverCardCSS = def.CustomHoverCardCSS
	...
	for _, entry := range s.plan.Mappings.ResourceCategories {
		...
		if entry.HasPayload {
			if def := findResourceCategoryDef(s.collector.resourceCategoryDefs, entry.SourceExportID); def != nil {
				...
				rc.CustomHeaderCSS = def.CustomHeaderCSS
				rc.CustomSidebar = def.CustomSidebar
				rc.CustomSidebarCSS = def.CustomSidebarCSS
				rc.CustomSummary = def.CustomSummary
				rc.CustomSummaryCSS = def.CustomSummaryCSS
				rc.CustomAvatar = def.CustomAvatar
				rc.CustomAvatarCSS = def.CustomAvatarCSS
				rc.CustomListHeader = def.CustomListHeader
				rc.CustomListHeaderCSS = def.CustomListHeaderCSS
				rc.CustomDetailFooter = def.CustomDetailFooter
				rc.CustomDetailFooterCSS = def.CustomDetailFooterCSS
				rc.CustomListFooter = def.CustomListFooter
				rc.CustomListFooterCSS = def.CustomListFooterCSS
				...
				rc.CustomPreviewCSS = def.CustomPreviewCSS
				rc.CustomLightbox = def.CustomLightbox
				rc.CustomLightboxCSS = def.CustomLightboxCSS
				rc.CustomCell = def.CustomCell
				rc.CustomCellCSS = def.CustomCellCSS
				if def.GUID != "" {
					guid := def.GUID
					rc.GUID = &guid
				}
