...
func buildCategory(creator *query_models.CategoryCreator) (models.Category, error) {
	...
	return models.Category{
		...
		CustomHeaderCSS:             creator.CustomHeaderCSS,
		CustomSidebar:               creator.CustomSidebar,
		CustomSidebarCSS:            creator.CustomSidebarCSS,
		CustomSummary:               creator.CustomSummary,
		CustomSummaryCSS:            creator.CustomSummaryCSS,
		CustomAvatar:                creator.CustomAvatar,
		CustomAvatarCSS:             creator.CustomAvatarCSS,
		CustomListHeader:            creator.CustomListHeader,
		CustomListHeaderCSS:         creator.CustomListHeaderCSS,
		CustomDetailFooter:          creator.CustomDetailFooter,
		CustomDetailFooterCSS:       creator.CustomDetailFooterCSS,
		CustomListFooter:            creator.CustomListFooter,
		CustomListFooterCSS:         creator.CustomListFooterCSS,
		CustomHoverCard:             creator.CustomHoverCard,
		CustomHoverCardCSS:          creator.CustomHoverCardCSS,
		CustomOwnEntities:           creator.CustomOwnEntities,
		CustomOwnEntitiesCSS:        creator.CustomOwnEntitiesCSS,
		CustomEntityPickerResult:    creator.CustomEntityPickerResult,
		CustomEntityPickerResultCSS: creator.CustomEntityPickerResultCSS,
		CustomMRQLResult:            creator.CustomMRQLResult,
		CustomMRQLResultCSS:         creator.CustomMRQLResultCSS,
...
func buildResourceCategory(creator *query_models.ResourceCategoryCreator) (models.ResourceCategory, error) {
	...
	return models.ResourceCategory{
		...
		CustomPreviewCSS:            creator.CustomPreviewCSS,
		CustomLightbox:              creator.CustomLightbox,
		CustomLightboxCSS:           creator.CustomLightboxCSS,
		CustomCell:                  creator.CustomCell,
		CustomCellCSS:               creator.CustomCellCSS,
		CustomEntityPickerResult:    creator.CustomEntityPickerResult,
		CustomEntityPickerResultCSS: creator.CustomEntityPickerResultCSS,
		CustomMRQLResult:            creator.CustomMRQLResult,
		CustomMRQLResultCSS:         creator.CustomMRQLResultCSS,
...
func buildNoteType(editor *query_models.NoteTypeEditor) (models.NoteType, error) {
	...
	return models.NoteType{
		...
		CustomHeaderCSS:             editor.CustomHeaderCSS,
		CustomSidebar:               editor.CustomSidebar,
		CustomSidebarCSS:            editor.CustomSidebarCSS,
		CustomSummary:               editor.CustomSummary,
		CustomSummaryCSS:            editor.CustomSummaryCSS,
		CustomAvatar:                editor.CustomAvatar,
		CustomAvatarCSS:             editor.CustomAvatarCSS,
		CustomListHeader:            editor.CustomListHeader,
		CustomListHeaderCSS:         editor.CustomListHeaderCSS,
		CustomDetailFooter:          editor.CustomDetailFooter,
		CustomDetailFooterCSS:       editor.CustomDetailFooterCSS,
		CustomListFooter:            editor.CustomListFooter,
		CustomListFooterCSS:         editor.CustomListFooterCSS,
		CustomHoverCard:             editor.CustomHoverCard,
		CustomHoverCardCSS:          editor.CustomHoverCardCSS,
		CustomMRQLResult:            editor.CustomMRQLResult,
		CustomMRQLResultCSS:         editor.CustomMRQLResultCSS,
		CustomEntityPickerResult:    editor.CustomEntityPickerResult,
		CustomEntityPickerResultCSS: editor.CustomEntityPickerResultCSS,
