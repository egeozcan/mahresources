...
rendering bits: `CustomHeader`, `CustomDetailFooter`, `CustomSidebar`,
`CustomSummary`, `CustomAvatar`, `CustomHoverCard`, `CustomListHeader`,
`CustomListFooter`, `CustomMRQLResult`, `CustomCSS`, and a `SectionConfig`
